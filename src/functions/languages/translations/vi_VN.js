...
export const OR_YOU_CAN_ASK_EVERYTHING_BY = `Hoặc bạn cũng có thể tán gẫu với ${BOT_NAME} bằng bất cứ vấn đề nào. Ví dụ: ${BOT_BUZZ_WORD}, em ăn cơm chưa?; ${BOT_BUZZ_WORD}, làm sao để đậu đại học?; ${BOT_BUZZ_WORD}, ...`;
