...
export const SOMETHING_WHEN_WRONG = "Có lỗi xảy ra";
...
export const TELEGRAM_INSTRUCTION = `Để thông qua Em Gái Thủy Lợi tra cứu thông tin tuyển sinh của Phân hiệu Đại học Thủy lợi, bạn thực hiện nhập \` / \` vào khung nội dung chat hoặc bấm nút "Menu" bên trái khung chat và chọn chức năng muốn sử dụng`;
...
export const MESSAGE_TOO_LONG = "Tin nhắn quá dài, Em Gái Thủy Lợi không thể hiểu được được. Bạn vui lòng thử lại với câu hỏi khác ngắn hơn";
